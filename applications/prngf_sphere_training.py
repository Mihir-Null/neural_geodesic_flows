"""
Training script for pseudo-Riemannian NGF on sphere trajectories (thesis dataset).
"""
...
config = get_wandb_config(
    ...
    g_arguments={
        "dim_M": 3,
        "hidden_sizes": [64, 64],
        "signature": (1, 2),  # one timelike, two spacelike as an example
        "min_diagonal": 1e-2,
        "min_scale": 1e-2,
    },
    batch_size=128,
