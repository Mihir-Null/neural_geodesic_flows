"""
Training script for pseudo-Riemannian NGF on two-body trajectories (thesis dataset).
"""
...
config = get_wandb_config(
    ...
    g_arguments={
        "dim_M": 4,
        "hidden_sizes": [64, 64],
        "signature": (2, 2),  # two positive, two negative directions
        "min_diagonal": 1e-2,
        "min_scale": 1e-2,
    },
    batch_size=128,
