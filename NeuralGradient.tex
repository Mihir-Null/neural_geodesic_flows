...
\begin{frame}
    ...
    \centering % Centers the image on the slide
    \includegraphics[width=0.5\textwidth]{funny.png}
\end{frame}
...
\begin{frame}
    ...
    \centering % Centers the image on the slide
    \includegraphics[width=0.8\textwidth]{manifoldhyp.png}
\end{frame}
...
\begin{frame}
    \frametitle{Dynamics}
    \centering % Centers the image on the slide
    \includegraphics[width=0.8\textwidth]{14.vector-bundle.png}
\end{frame}
...
%     \frametitle{Motivation}
%     \centering % Centers the image on the slide
%     \includegraphics[width=0.8\textwidth]{training.gif}
% \end{frame}
